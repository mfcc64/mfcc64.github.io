import "https://cdn.jsdelivr.net/npm/showcqt-element@1.0.1/showcqt-element.mjs";

(async function(){
    const current_script = import.meta.url;

    const defaults = {
        height:     { def: 60, min: 20, max:100 },
        bar:        { def: 17, min:  3, max: 33 },
        waterfall:  { def: 60, min:  0, max: 80 },
    ...
    const opt_prefix = "__showcqt_spectrogram_opt_";
